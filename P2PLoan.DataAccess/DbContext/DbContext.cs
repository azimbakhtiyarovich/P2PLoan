...
namespace P2PLoan.DataAccess
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<Role> Roles { get; set; } // qo‘shish kerak
        public DbSet<UserRole> UserRoles { get; set; } // qo‘shish kerak
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Optional: navigatsiya konfiguratsiyasi
            modelBuilder.Entity<UserRole>()
                .HasOne(ur => ur.User)
            ...
            modelBuilder.Entity<Investment>()
                ...
                .OnDelete(DeleteBehavior.Restrict); // yoki NoAction
